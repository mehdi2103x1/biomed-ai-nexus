...
PRIMARY_COLOR: str = "#cc785c"     # Claude terracotta
ACCENT_COLOR: str = "#b8623f"      # deep terracotta
DANGER_COLOR: str = "#bd4636"      # clinical red (disease / positive)
OK_COLOR: str = "#5b8266"          # sage green (healthy / negative)
